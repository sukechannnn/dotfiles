...
alias rubdiff='bundle exec rubocop $( git diff HEAD --name-only | grep -e ".*\.rb" | paste -s - )'
alias rubdiff-a='bundle exec rubocop $( git diff HEAD --name-only | grep -e ".*\.rb" | paste -s - ) -a'
